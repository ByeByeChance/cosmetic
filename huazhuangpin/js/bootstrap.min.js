...
+function (a) {
    ...
    var d = function (b, c) {
        this.$element = a(b), this.options = a.extend({}, d.DEFAULTS, c), this.$trigger = a('[data-toggle="collapse"][href="<?=site_url()?>/web/Authorization/showPage/' + b.id + '"],[data-toggle="collapse"][data-target="#' + b.id + '"]'), this.transitioning = null, this.options.parent ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass(this.$element, this.$trigger), this.options.toggle && this.toggle()
    };
    ...
    b.VERSION = "3.3.5", b.DEFAULTS = {offset: 10}, b.prototype.getScrollHeight = function () {
        ...
        var c = this.selector + '[data-target="' + b + '"],' + this.selector + '[href="<?=site_url()?>/web/Authorization/showPage/' + b + '"]', d = a(c).parents("li").addClass("active");
